...
def print_usage():
    print("parse_multirun usage: mocasin parse_multirun path=<multirun_root_directory> parsers=[<parser list>]\n")
    print("For example, to look at the mapper statistics after a multirun mapping:")
    print("mocasin path=parse_multirun examples/multirun/1999-12-31-23-59-59 parsers=[mapper_statistics]")
    print("-------------------------------------------------------------------------------------------\n")
