...
class Exynos2Chips(Platform):
    def __init__(self):
        ...
        for i in range(0, 16):
            self.add_scheduler(
                Scheduler(
                    "sched%02d" % i, [self.find_processor("PE%02d" % i)], [sp]
                )
            )
        ...
        for i in range(0, 4):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C0_A7, l3_C0], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C0_A7, l3_C0], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        for i in range(4, 8):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C0_A15, l3_C0], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C0_A15, l3_C0], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        self.add_primitive(prim)
        ...
        for i in range(8, 12):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C1_A7, l3_C1], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C1_A7, l3_C1], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        for i in range(12, 16):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C1_A15, l3_C1], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C1_A15, l3_C1], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        self.add_primitive(prim)
        ...
        for i in range(0, 4):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C0_A7, l3_C0, ram], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C0_A7, l3_C0, ram], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        for i in range(4, 8):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C0_A15, l3_C0, ram], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C0_A15, l3_C0, ram], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        for i in range(8, 12):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C1_A7, l3_C1, ram], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C1_A7, l3_C1, ram], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        for i in range(12, 16):
            ...
            produce = CommunicationPhase(
                "produce", [l1, l2_C1_A15, l3_C1, ram], "write"
            )
            consume = CommunicationPhase(
                "consume", [l1, l2_C1_A15, l3_C1, ram], "read"
            )
            prim.add_producer(pe, [produce])
            prim.add_consumer(pe, [consume])
        self.add_primitive(prim)
