...
class DesignerPlatformMesh(Platform):
    def __init__(self, processor_0, processor_1, name="parallella-styled", symmetries_json=None,embedding_json=None):
        super(DesignerPlatformMesh, self).__init__(name,symmetries_json,embedding_json)
