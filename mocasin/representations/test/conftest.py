...
import pytest
import numpy as np
from mocasin.representations import permutations as perm
...
def autExampleClusterArch():
    ...
    return perm.ProductGroup(
        [S4, S4, S4, S4]
    )  # this should actually be a wreath product...
...
def exampleDijkstra():
    ...
    return {
        "N0": [("N1", 40), ("N2", 15)],
        "N2": [("N0", 15), ("N3", 100), ("N1", 20)],
        "N3": [("N2", 100), ("N1", 10)],
        "N1": [("N0", 40), ("N2", 20), ("N3", 10), ("N5", 6), ("N4", 25)],
        "N4": [("N1", 25), ("N5", 8)],
        "N5": [("N1", 6), ("N4", 8)],
    }
