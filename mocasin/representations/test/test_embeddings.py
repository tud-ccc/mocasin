...
from mocasin.representations.embeddings import MetricSpaceEmbeddingBase, MetricSpaceEmbedding, _f_emb_approx
...
class TestEmbeddings(object):
    ...
    def test_Evec(self, exampleClusterArch, dimension):
        ...
        assert(dist / Evec.distortion < dist_embedded and dist_embedded < dist * Evec.distortion)
