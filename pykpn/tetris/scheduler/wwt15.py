...
class WWT15Scheduler(SingleVariantSegmentizedScheduler):
    def __init__(self, app_table, platform, config, name):
        sorting_arg = config['resource_manager']["wwt15_sorting"]
        if sorting_arg == "COST":
        ...
        explore_arg = config['resource_manager']["wwt15_seg_explore"]
        if explore_arg == "ALL":
        ...
        lr_constraints_arg = config['resource_manager']["wwt15_lr"]
        ...
        self.__lr_rounds = config['resource_manager']["wwt15_lr_rounds"]
