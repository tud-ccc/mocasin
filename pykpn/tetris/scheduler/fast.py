...
class FastSegmentMapper(SingleVariantSegmentMapper):
    ...
    def __select_app_mappings_fit_deadline_resources(self, app, deadline, avl_core_types, completion = 0.0):
        res = []
    ...
    def __create_mapping_from_list(self, clist):
        ...
        new_segment = SegmentMapping(self.platform, segment_mapping_list,
