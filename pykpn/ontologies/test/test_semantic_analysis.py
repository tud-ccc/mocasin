...
class TestSemanticAnalysis(object):
    ...
    def test_query_1(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_2(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_3(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_4(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_5(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_6(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_7(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_8(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_9(self, parser, kpnGraph, platform, cfg):
    ...
    def test_query_10(self, parser, kpnGraph, platform, cfg):
