...
class drawAPI():
    '''
    drawManager must be a canvas object whicht should draw the elements, height and width of canvas will be draw heiht and width, border
    ...
    means each element will take 1/15 of the remaining heightk, width and height should match width and height of the canvas
    '''
    ...
    '''
    first method that should be called, requires an object of the platform class an sets platform description and equalList
    ...
    '''
    after initialization of the drawAPI class via constructor and setPlatform method, draw can be called whicht introduces
