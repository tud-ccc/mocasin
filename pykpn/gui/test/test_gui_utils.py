...
class TestPlatformOperations(object):
    ...
    def test_getPlatformDescription_1(self, exynos):
        ...
        assert(result == [('comm_DRAM', [('comm_DRAM', [('comm_L2_A7', [('comm_L2_A7', [('comm_L1_ARM00',
                        [('comm_L1_ARM00', ['ARM00'])]), ('comm_L1_ARM01', [('comm_L1_ARM01', ['ARM01'])]),
                        ('comm_L1_ARM02', [('comm_L1_ARM02', ['ARM02'])]), ('comm_L1_ARM03', [('comm_L1_ARM03',
                        ['ARM03'])])])]), ('comm_L2_A15', [('comm_L2_A15', [('comm_L1_ARM04', [('comm_L1_ARM04',
    ...
    def test_getPlatformDescription_2(self, parallella):
        ...
        result = po.getPlatformDescription(processors, primitives)
        assert(result == [('EMEM', [('hostToHostCached', ['ARM0', 'ARM1']), ('meshDirect_E15', [('meshDirect_E14',
                        [('meshDirect_E13', [('meshDirect_E12', [('meshDirect_E11', [('meshDirect_E10', [('meshDirect_E09',
                        [('meshDirect_E08', [('meshDirect_E07', [('meshDirect_E06', [('meshDirect_E05', [('meshDirect_E04',
                        [('meshDirect_E03', [('meshDirect_E02', [('meshDirect_E01', [('meshDirect_E00',
    ...
    def test_findEqualPrimitives_1(self, exynos):
        ...
        assert(result == [['comm_L1_ARM00', 'comm_L1_ARM00_putget'], ['comm_L1_ARM01', 'comm_L1_ARM01_putget'],
                          ['comm_L1_ARM02', 'comm_L1_ARM02_putget'], ['comm_L1_ARM03', 'comm_L1_ARM03_putget'],
                          ['comm_L1_ARM04', 'comm_L1_ARM04_putget'], ['comm_L1_ARM05', 'comm_L1_ARM05_putget'],
                          ['comm_L1_ARM06', 'comm_L1_ARM06_putget'], ['comm_L1_ARM07', 'comm_L1_ARM07_putget'],
    ...
    def test_findEqualPrimitives_2(self, parallella):
        ...
        assert(result == [['EMEM'], ['hostToHostCached'], ['meshDirect_E00', 'meshDirect_E01', 'meshDirect_E02',
                        'meshDirect_E03', 'meshDirect_E04', 'meshDirect_E05', 'meshDirect_E06', 'meshDirect_E07',
    ...
    def test_mergeEqualPrimitives_1(self, exynos):
        ...
        assert(result == [('comm_DRAM', [('comm_L2_A7', [('network_on_chip', ['ARM00']), ('network_on_chip', ['ARM01']),
                        ('network_on_chip', ['ARM02']), ('network_on_chip', ['ARM03'])]), ('comm_L2_A15', [('network_on_chip',
    ...
    def test_mergeEqualPrimitives_2(self, parallella):
        ...
        result = po.mergeEqualPrimitives(platformDescription, equalList)
        assert(result == [('EMEM', [('hostToHostCached', ['ARM0', 'ARM1']), ('network_on_chip', [('network_on_chip',
    ...
    def test_createNOCMatrix(self, parallella):
        ...
        platformDescription = po.getPlatformDescription(processors, primitives)
        equalList = po.findEqualPrimitives(parallella)
        platformDescription = po.mergeEqualPrimitives(platformDescription, equalList)
