...
#
# Generated Fri Jun 16 17:08:40 2017 by generateDS.py version 2.26a.
#
...
#
# Command line:
#   /net/home/cmenard/.local/bin/generateDS -o "mapping.py" SlxMappingDescriptor.xsd
#
# Current working directory (os.getcwd()):
#   slx_mapping_descriptor
#
...
class ProcessType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, priority=None, iterationCount=None, powerPriority=None, powerPeakValue=None, powerPeakUnit='W', powerFrequencyValue=None, powerFrequencyUnit='Hz', powerVoltageValue=None, powerVoltageUnit='V', ProcessorAffinityRef=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        self.priority = _cast(None, priority)
        self.iterationCount = _cast(None, iterationCount)
        self.powerPriority = _cast(None, powerPriority)
        self.powerPeakValue = _cast(None, powerPeakValue)
        self.powerPeakUnit = _cast(None, powerPeakUnit)
        self.powerFrequencyValue = _cast(None, powerFrequencyValue)
        self.powerFrequencyUnit = _cast(None, powerFrequencyUnit)
        self.powerVoltageValue = _cast(None, powerVoltageValue)
        self.powerVoltageUnit = _cast(None, powerVoltageUnit)
        if ProcessorAffinityRef is None:
            self.ProcessorAffinityRef = []
        else:
            self.ProcessorAffinityRef = ProcessorAffinityRef
    ...
    def get_ProcessorAffinityRef(self): return self.ProcessorAffinityRef
    def set_ProcessorAffinityRef(self, ProcessorAffinityRef): self.ProcessorAffinityRef = ProcessorAffinityRef
    def add_ProcessorAffinityRef(self, value): self.ProcessorAffinityRef.append(value)
    def insert_ProcessorAffinityRef_at(self, index, value): self.ProcessorAffinityRef.insert(index, value)
    def replace_ProcessorAffinityRef_at(self, index, value): self.ProcessorAffinityRef[index] = value
    ...
    def get_powerPriority(self): return self.powerPriority
    def set_powerPriority(self, powerPriority): self.powerPriority = powerPriority
    def get_powerPeakValue(self): return self.powerPeakValue
    def set_powerPeakValue(self, powerPeakValue): self.powerPeakValue = powerPeakValue
    def get_powerPeakUnit(self): return self.powerPeakUnit
    def set_powerPeakUnit(self, powerPeakUnit): self.powerPeakUnit = powerPeakUnit
    def get_powerFrequencyValue(self): return self.powerFrequencyValue
    def set_powerFrequencyValue(self, powerFrequencyValue): self.powerFrequencyValue = powerFrequencyValue
    def get_powerFrequencyUnit(self): return self.powerFrequencyUnit
    def set_powerFrequencyUnit(self, powerFrequencyUnit): self.powerFrequencyUnit = powerFrequencyUnit
    def get_powerVoltageValue(self): return self.powerVoltageValue
    def set_powerVoltageValue(self, powerVoltageValue): self.powerVoltageValue = powerVoltageValue
    def get_powerVoltageUnit(self): return self.powerVoltageUnit
    def set_powerVoltageUnit(self, powerVoltageUnit): self.powerVoltageUnit = powerVoltageUnit
    def validate_PriorityType(self, value):
        # Validate type PriorityType, a restriction on slxplatform:NonNegativeIntType.
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessType'):
        ...
        if self.iterationCount is not None and 'iterationCount' not in already_processed:
            already_processed.add('iterationCount')
            outfile.write(' iterationCount=%s' % (quote_attrib(self.iterationCount), ))
        if self.powerPriority is not None and 'powerPriority' not in already_processed:
            already_processed.add('powerPriority')
            outfile.write(' powerPriority=%s' % (quote_attrib(self.powerPriority), ))
        if self.powerPeakValue is not None and 'powerPeakValue' not in already_processed:
            already_processed.add('powerPeakValue')
            outfile.write(' powerPeakValue=%s' % (quote_attrib(self.powerPeakValue), ))
        if self.powerPeakUnit != "W" and 'powerPeakUnit' not in already_processed:
            already_processed.add('powerPeakUnit')
            outfile.write(' powerPeakUnit=%s' % (quote_attrib(self.powerPeakUnit), ))
        if self.powerFrequencyValue is not None and 'powerFrequencyValue' not in already_processed:
            already_processed.add('powerFrequencyValue')
            outfile.write(' powerFrequencyValue=%s' % (quote_attrib(self.powerFrequencyValue), ))
        if self.powerFrequencyUnit != "Hz" and 'powerFrequencyUnit' not in already_processed:
            already_processed.add('powerFrequencyUnit')
            outfile.write(' powerFrequencyUnit=%s' % (quote_attrib(self.powerFrequencyUnit), ))
        if self.powerVoltageValue is not None and 'powerVoltageValue' not in already_processed:
            already_processed.add('powerVoltageValue')
            outfile.write(' powerVoltageValue=%s' % (quote_attrib(self.powerVoltageValue), ))
        if self.powerVoltageUnit != "V" and 'powerVoltageUnit' not in already_processed:
            already_processed.add('powerVoltageUnit')
            outfile.write(' powerVoltageUnit=%s' % (quote_attrib(self.powerVoltageUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for ProcessorAffinityRef_ in self.ProcessorAffinityRef:
            ProcessorAffinityRef_.export(outfile, level, namespace_, name_='ProcessorAffinityRef', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'priority' not in already_processed:
            already_processed.add('priority')
            self.priority = value
            self.validate_PriorityType(self.priority)    # validate type PriorityType
        value = find_attr_value_('iterationCount', node)
        if value is not None and 'iterationCount' not in already_processed:
            already_processed.add('iterationCount')
            self.iterationCount = value
        value = find_attr_value_('powerPriority', node)
        if value is not None and 'powerPriority' not in already_processed:
            already_processed.add('powerPriority')
            self.powerPriority = value
            self.validate_PriorityType(self.powerPriority)    # validate type PriorityType
        value = find_attr_value_('powerPeakValue', node)
        if value is not None and 'powerPeakValue' not in already_processed:
            already_processed.add('powerPeakValue')
            self.powerPeakValue = value
        value = find_attr_value_('powerPeakUnit', node)
        if value is not None and 'powerPeakUnit' not in already_processed:
            already_processed.add('powerPeakUnit')
            self.powerPeakUnit = value
        value = find_attr_value_('powerFrequencyValue', node)
        if value is not None and 'powerFrequencyValue' not in already_processed:
            already_processed.add('powerFrequencyValue')
            self.powerFrequencyValue = value
        value = find_attr_value_('powerFrequencyUnit', node)
        if value is not None and 'powerFrequencyUnit' not in already_processed:
            already_processed.add('powerFrequencyUnit')
            self.powerFrequencyUnit = value
        value = find_attr_value_('powerVoltageValue', node)
        if value is not None and 'powerVoltageValue' not in already_processed:
            already_processed.add('powerVoltageValue')
            self.powerVoltageValue = value
        value = find_attr_value_('powerVoltageUnit', node)
        if value is not None and 'powerVoltageUnit' not in already_processed:
            already_processed.add('powerVoltageUnit')
            self.powerVoltageUnit = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ProcessorAffinityRef':
            obj_ = ProcessorRefType.factory()
            obj_.build(child_)
            self.ProcessorAffinityRef.append(obj_)
            obj_.original_tagname_ = 'ProcessorAffinityRef'
...
class ProcessRefType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ProcessRefType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessRefType'):
        if self.process is not None and 'process' not in already_processed:
            already_processed.add('process')
            outfile.write(' process=%s' % (quote_attrib(self.process), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class ChannelType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, bound=None, wrapLength=None, commPrimitive=None, processWriter=None, ProcessReaderRef=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        self.bound = _cast(None, bound)
        self.wrapLength = _cast(None, wrapLength)
        self.commPrimitive = _cast(None, commPrimitive)
        self.processWriter = _cast(None, processWriter)
        if ProcessReaderRef is None:
            self.ProcessReaderRef = []
        else:
            self.ProcessReaderRef = ProcessReaderRef
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    factory = staticmethod(factory)
    def get_ProcessReaderRef(self): return self.ProcessReaderRef
    def set_ProcessReaderRef(self, ProcessReaderRef): self.ProcessReaderRef = ProcessReaderRef
    def add_ProcessReaderRef(self, value): self.ProcessReaderRef.append(value)
    def insert_ProcessReaderRef_at(self, index, value): self.ProcessReaderRef.insert(index, value)
    def replace_ProcessReaderRef_at(self, index, value): self.ProcessReaderRef[index] = value
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def get_bound(self): return self.bound
    def set_bound(self, bound): self.bound = bound
    def get_wrapLength(self): return self.wrapLength
    def set_wrapLength(self, wrapLength): self.wrapLength = wrapLength
    ...
    def get_processWriter(self): return self.processWriter
    def set_processWriter(self, processWriter): self.processWriter = processWriter
    def validate_ChannelBoundType(self, value):
        # Validate type ChannelBoundType, a restriction on slxplatform:PositiveIntType.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_WrapLengthType(self, value):
        # Validate type WrapLengthType, a restriction on slxplatform:NonNegativeIntType.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ChannelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ChannelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ChannelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        ...
        if self.wrapLength is not None and 'wrapLength' not in already_processed:
            already_processed.add('wrapLength')
            outfile.write(' wrapLength=%s' % (quote_attrib(self.wrapLength), ))
        if self.commPrimitive is not None and 'commPrimitive' not in already_processed:
            already_processed.add('commPrimitive')
            outfile.write(' commPrimitive=%s' % (quote_attrib(self.commPrimitive), ))
        if self.processWriter is not None and 'processWriter' not in already_processed:
            already_processed.add('processWriter')
            outfile.write(' processWriter=%s' % (quote_attrib(self.processWriter), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ChannelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for ProcessReaderRef_ in self.ProcessReaderRef:
            ProcessReaderRef_.export(outfile, level, namespace_, name_='ProcessReaderRef', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'bound' not in already_processed:
            already_processed.add('bound')
            self.bound = value
            self.validate_ChannelBoundType(self.bound)    # validate type ChannelBoundType
        value = find_attr_value_('wrapLength', node)
        if value is not None and 'wrapLength' not in already_processed:
            already_processed.add('wrapLength')
            self.wrapLength = value
            self.validate_WrapLengthType(self.wrapLength)    # validate type WrapLengthType
        ...
        value = find_attr_value_('processWriter', node)
        if value is not None and 'processWriter' not in already_processed:
            already_processed.add('processWriter')
            self.processWriter = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ProcessReaderRef':
            obj_ = ProcessRefType.factory()
            obj_.build(child_)
            self.ProcessReaderRef.append(obj_)
            obj_.original_tagname_ = 'ProcessReaderRef'
# end class ChannelType


class ChannelRefType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ChannelRefType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ChannelRefType.subclass:
            return ChannelRefType.subclass(*args_, **kwargs_)
        else:
            return ChannelRefType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ChannelRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ChannelRefType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ChannelRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ChannelRefType'):
        if self.channel is not None and 'channel' not in already_processed:
            already_processed.add('channel')
            outfile.write(' channel=%s' % (quote_attrib(self.channel), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ChannelRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class ChannelRefType


class ProcessorType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, type_=None, frequencyValue=None, frequencyUnit='Hz', voltageValue=None, voltageUnit='V', powerIdleValue=None, powerIdleUnit='W'):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        ...
        self.powerIdleValue = _cast(None, powerIdleValue)
        self.powerIdleUnit = _cast(None, powerIdleUnit)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_powerIdleValue(self): return self.powerIdleValue
    def set_powerIdleValue(self, powerIdleValue): self.powerIdleValue = powerIdleValue
    def get_powerIdleUnit(self): return self.powerIdleUnit
    def set_powerIdleUnit(self, powerIdleUnit): self.powerIdleUnit = powerIdleUnit
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessorType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessorType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessorType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        ...
        if self.frequencyUnit != "Hz" and 'frequencyUnit' not in already_processed:
        ...
        if self.voltageUnit != "V" and 'voltageUnit' not in already_processed:
            already_processed.add('voltageUnit')
            outfile.write(' voltageUnit=%s' % (quote_attrib(self.voltageUnit), ))
        if self.powerIdleValue is not None and 'powerIdleValue' not in already_processed:
            already_processed.add('powerIdleValue')
            outfile.write(' powerIdleValue=%s' % (quote_attrib(self.powerIdleValue), ))
        if self.powerIdleUnit != "W" and 'powerIdleUnit' not in already_processed:
            already_processed.add('powerIdleUnit')
            outfile.write(' powerIdleUnit=%s' % (quote_attrib(self.powerIdleUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessorType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        value = find_attr_value_('powerIdleValue', node)
        if value is not None and 'powerIdleValue' not in already_processed:
            already_processed.add('powerIdleValue')
            self.powerIdleValue = value
        value = find_attr_value_('powerIdleUnit', node)
        if value is not None and 'powerIdleUnit' not in already_processed:
            already_processed.add('powerIdleUnit')
            self.powerIdleUnit = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
...
class ProcessorRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessorRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessorRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessorRefType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessorRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class CommPrimitiveType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CommPrimitiveType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CommPrimitiveType.subclass:
            return CommPrimitiveType.subclass(*args_, **kwargs_)
        else:
            return CommPrimitiveType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommPrimitiveType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CommPrimitiveType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommPrimitiveType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommPrimitiveType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommPrimitiveType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class CommPrimitiveType


class CommPrimitiveRefType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, commPrimitive=None):
        self.original_tagname_ = None
        self.commPrimitive = _cast(None, commPrimitive)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CommPrimitiveRefType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CommPrimitiveRefType.subclass:
            return CommPrimitiveRefType.subclass(*args_, **kwargs_)
        else:
            return CommPrimitiveRefType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_commPrimitive(self): return self.commPrimitive
    def set_commPrimitive(self, commPrimitive): self.commPrimitive = commPrimitive
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommPrimitiveRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='CommPrimitiveRefType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommPrimitiveRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommPrimitiveRefType'):
        if self.commPrimitive is not None and 'commPrimitive' not in already_processed:
            already_processed.add('commPrimitive')
            outfile.write(' commPrimitive=%s' % (quote_attrib(self.commPrimitive), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommPrimitiveRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class CommPrimitiveRefType


class SchedulerType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, policy=None, timeSliceValue=None, timeSliceUnit='s', ProcessRef=None, ProcessorRef=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        self.policy = _cast(None, policy)
    ...
    def get_ProcessorRef(self): return self.ProcessorRef
    def set_ProcessorRef(self, ProcessorRef): self.ProcessorRef = ProcessorRef
    def add_ProcessorRef(self, value): self.ProcessorRef.append(value)
    def insert_ProcessorRef_at(self, index, value): self.ProcessorRef.insert(index, value)
    def replace_ProcessorRef_at(self, index, value): self.ProcessorRef[index] = value
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SchedulerType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SchedulerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SchedulerType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.policy is not None and 'policy' not in already_processed:
            already_processed.add('policy')
            outfile.write(' policy=%s' % (quote_attrib(self.policy), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SchedulerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for ProcessorRef_ in self.ProcessorRef:
            ProcessorRef_.export(outfile, level, namespace_, name_='ProcessorRef', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'id' not in already_processed:
            already_processed.add('id')
            self.id = value
        value = find_attr_value_('policy', node)
        if value is not None and 'policy' not in already_processed:
            already_processed.add('policy')
            self.policy = value
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ProcessRef':
            obj_ = ProcessRefType.factory()
            obj_.build(child_)
            self.ProcessRef.append(obj_)
            obj_.original_tagname_ = 'ProcessRef'
        elif nodeName_ == 'ProcessorRef':
            obj_ = ProcessorRefType.factory()
            obj_.build(child_)
            self.ProcessorRef.append(obj_)
            obj_.original_tagname_ = 'ProcessorRef'
# end class SchedulerType


class SchedulerRefType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SchedulerRefType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SchedulerRefType.subclass:
            return SchedulerRefType.subclass(*args_, **kwargs_)
        else:
            return SchedulerRefType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SchedulerRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SchedulerRefType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SchedulerRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SchedulerRefType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SchedulerRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class SchedulerRefType


class MappingType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, version=None, platformName=None, applicationName=None, globalChannelBound=None, powerBudgetValue=None, powerBudgetUnit='W', Process=None, Channel=None, Processor=None, CommPrimitive=None, Scheduler=None):
        self.original_tagname_ = None
        self.version = _cast(None, version)
        self.platformName = _cast(None, platformName)
        self.applicationName = _cast(None, applicationName)
        self.globalChannelBound = _cast(None, globalChannelBound)
        self.powerBudgetValue = _cast(None, powerBudgetValue)
        self.powerBudgetUnit = _cast(None, powerBudgetUnit)
        if Process is None:
            self.Process = []
        else:
        ...
        if CommPrimitive is None:
            self.CommPrimitive = []
        else:
            self.CommPrimitive = CommPrimitive
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, MappingType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if MappingType.subclass:
            return MappingType.subclass(*args_, **kwargs_)
        else:
            return MappingType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_Process(self): return self.Process
    def set_Process(self, Process): self.Process = Process
    ...
    def get_CommPrimitive(self): return self.CommPrimitive
    def set_CommPrimitive(self, CommPrimitive): self.CommPrimitive = CommPrimitive
    def add_CommPrimitive(self, value): self.CommPrimitive.append(value)
    def insert_CommPrimitive_at(self, index, value): self.CommPrimitive.insert(index, value)
    def replace_CommPrimitive_at(self, index, value): self.CommPrimitive[index] = value
    def get_Scheduler(self): return self.Scheduler
    def set_Scheduler(self, Scheduler): self.Scheduler = Scheduler
    ...
    def get_globalChannelBound(self): return self.globalChannelBound
    def set_globalChannelBound(self, globalChannelBound): self.globalChannelBound = globalChannelBound
    def get_powerBudgetValue(self): return self.powerBudgetValue
    def set_powerBudgetValue(self, powerBudgetValue): self.powerBudgetValue = powerBudgetValue
    def get_powerBudgetUnit(self): return self.powerBudgetUnit
    def set_powerBudgetUnit(self, powerBudgetUnit): self.powerBudgetUnit = powerBudgetUnit
    def validate_ChannelBoundType(self, value):
        # Validate type ChannelBoundType, a restriction on slxplatform:PositiveIntType.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            self.Channel or
            self.Processor or
            self.CommPrimitive or
            self.Scheduler
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MappingType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='MappingType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MappingType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MappingType'):
        if self.version is not None and 'version' not in already_processed:
            already_processed.add('version')
            outfile.write(' version=%s' % (quote_attrib(self.version), ))
        if self.platformName is not None and 'platformName' not in already_processed:
            already_processed.add('platformName')
            outfile.write(' platformName=%s' % (quote_attrib(self.platformName), ))
        if self.applicationName is not None and 'applicationName' not in already_processed:
            already_processed.add('applicationName')
            outfile.write(' applicationName=%s' % (quote_attrib(self.applicationName), ))
        if self.globalChannelBound is not None and 'globalChannelBound' not in already_processed:
            already_processed.add('globalChannelBound')
            outfile.write(' globalChannelBound=%s' % (quote_attrib(self.globalChannelBound), ))
        if self.powerBudgetValue is not None and 'powerBudgetValue' not in already_processed:
            already_processed.add('powerBudgetValue')
            outfile.write(' powerBudgetValue=%s' % (quote_attrib(self.powerBudgetValue), ))
        if self.powerBudgetUnit != "W" and 'powerBudgetUnit' not in already_processed:
            already_processed.add('powerBudgetUnit')
            outfile.write(' powerBudgetUnit=%s' % (quote_attrib(self.powerBudgetUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MappingType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for CommPrimitive_ in self.CommPrimitive:
            CommPrimitive_.export(outfile, level, namespace_, name_='CommPrimitive', pretty_print=pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'version' not in already_processed:
            already_processed.add('version')
            self.version = value
        value = find_attr_value_('platformName', node)
        if value is not None and 'platformName' not in already_processed:
            already_processed.add('platformName')
            self.platformName = value
        value = find_attr_value_('applicationName', node)
        if value is not None and 'applicationName' not in already_processed:
            already_processed.add('applicationName')
            self.applicationName = value
        value = find_attr_value_('globalChannelBound', node)
        if value is not None and 'globalChannelBound' not in already_processed:
            already_processed.add('globalChannelBound')
            self.globalChannelBound = value
            self.validate_ChannelBoundType(self.globalChannelBound)    # validate type ChannelBoundType
        value = find_attr_value_('powerBudgetValue', node)
        if value is not None and 'powerBudgetValue' not in already_processed:
            already_processed.add('powerBudgetValue')
            self.powerBudgetValue = value
        value = find_attr_value_('powerBudgetUnit', node)
        if value is not None and 'powerBudgetUnit' not in already_processed:
            already_processed.add('powerBudgetUnit')
            self.powerBudgetUnit = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'CommPrimitive':
            obj_ = CommPrimitiveType.factory()
            obj_.build(child_)
            self.CommPrimitive.append(obj_)
            obj_.original_tagname_ = 'CommPrimitive'
...
class VoltageDomainType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageDomainType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageDomainType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageDomainType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageDomainType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class FrequencyDomainType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyDomainType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyDomainType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyDomainType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.switchTimeValue != "0" and 'switchTimeValue' not in already_processed:
        ...
        if self.switchTimeUnit != "us" and 'switchTimeUnit' not in already_processed:
            already_processed.add('switchTimeUnit')
            outfile.write(' switchTimeUnit=%s' % (quote_attrib(self.switchTimeUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyDomainType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class VoltageDomainConditionType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageDomainConditionType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageDomainConditionType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageDomainConditionType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageDomainConditionType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class FrequencyDomainConditionType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyDomainConditionType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyDomainConditionType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyDomainConditionType'):
        ...
        if self.unit is not None and 'unit' not in already_processed:
            already_processed.add('unit')
            outfile.write(' unit=%s' % (quote_attrib(self.unit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyDomainConditionType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class VoltageFrequencyDomainConditionListType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageFrequencyDomainConditionListType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageFrequencyDomainConditionListType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageFrequencyDomainConditionListType'):
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageFrequencyDomainConditionListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class VoltageConditionType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageConditionType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageConditionType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageConditionType'):
        if self.condition is not None and 'condition' not in already_processed:
            already_processed.add('condition')
            outfile.write(' condition=%s' % (quote_attrib(self.condition), ))
        if self.value is not None and 'value' not in already_processed:
        ...
        if self.unit is not None and 'unit' not in already_processed:
            already_processed.add('unit')
            outfile.write(' unit=%s' % (quote_attrib(self.unit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageConditionType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class FrequencyConditionType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyConditionType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyConditionType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyConditionType'):
        if self.condition is not None and 'condition' not in already_processed:
            already_processed.add('condition')
            outfile.write(' condition=%s' % (quote_attrib(self.condition), ))
        if self.value is not None and 'value' not in already_processed:
        ...
        if self.unit is not None and 'unit' not in already_processed:
            already_processed.add('unit')
            outfile.write(' unit=%s' % (quote_attrib(self.unit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyConditionType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class FrequencyVoltageConditionType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyVoltageConditionType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyVoltageConditionType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyVoltageConditionType'):
        if self.frequencyValue is not None and 'frequencyValue' not in already_processed:
            already_processed.add('frequencyValue')
            outfile.write(' frequencyValue=%s' % (quote_attrib(self.frequencyValue), ))
        ...
        if self.voltageUnit is not None and 'voltageUnit' not in already_processed:
            already_processed.add('voltageUnit')
            outfile.write(' voltageUnit=%s' % (quote_attrib(self.voltageUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyVoltageConditionType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class VoltageFrequencyConditionListType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageFrequencyConditionListType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageFrequencyConditionListType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageFrequencyConditionListType'):
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageFrequencyConditionListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SchedulingPolicyType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SchedulingPolicyType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SchedulingPolicyType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SchedulingPolicyType'):
        ...
        if self.timeSliceUnit != "s" and 'timeSliceUnit' not in already_processed:
            already_processed.add('timeSliceUnit')
            outfile.write(' timeSliceUnit=%s' % (quote_attrib(self.timeSliceUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SchedulingPolicyType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class SchedulingPolicyListType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SchedulingPolicyListType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SchedulingPolicyListType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SchedulingPolicyListType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SchedulingPolicyListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ProcessorPowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessorPowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessorPowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessorPowerStateType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessorPowerStateType', fromsubclass_=False, pretty_print=True):
...
class ProcessorPowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='ProcessorPowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='ProcessorPowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='ProcessorPowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='ProcessorPowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class MemoryPowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MemoryPowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MemoryPowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MemoryPowerStateType'):
        ...
        if self.powerUnit != "pW" and 'powerUnit' not in already_processed:
            already_processed.add('powerUnit')
            outfile.write(' powerUnit=%s' % (quote_attrib(self.powerUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MemoryPowerStateType', fromsubclass_=False, pretty_print=True):
...
class MemoryPowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MemoryPowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MemoryPowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MemoryPowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.leakageCurrentValue != "0" and 'leakageCurrentValue' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MemoryPowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class MemoryType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MemoryType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MemoryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MemoryType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MemoryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class MemoryRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MemoryRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MemoryRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MemoryRefType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MemoryRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class MemoryAccessType(MemoryRefType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='MemoryAccessType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='MemoryAccessType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='MemoryAccessType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='MemoryAccessType', fromsubclass_=False, pretty_print=True):
...
class CachePowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CachePowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CachePowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CachePowerStateType'):
        ...
        if self.powerUnit != "pW" and 'powerUnit' not in already_processed:
            already_processed.add('powerUnit')
            outfile.write(' powerUnit=%s' % (quote_attrib(self.powerUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CachePowerStateType', fromsubclass_=False, pretty_print=True):
...
class CachePowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CachePowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CachePowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CachePowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.leakageCurrentValue != "0" and 'leakageCurrentValue' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CachePowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CacheType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CacheType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CacheType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CacheType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CacheType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CacheRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CacheRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CacheRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CacheRefType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CacheRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class CacheAccessType(CacheRefType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CacheAccessType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CacheAccessType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CacheAccessType'):
        super(CacheAccessType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='CacheAccessType')
        if self.access is not None and 'access' not in already_processed:
            already_processed.add('access')
            outfile.write(' access=%s' % (quote_attrib(self.access), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CacheAccessType', fromsubclass_=False, pretty_print=True):
...
class FifoPowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FifoPowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FifoPowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FifoPowerStateType'):
        ...
        if self.powerUnit != "pW" and 'powerUnit' not in already_processed:
            already_processed.add('powerUnit')
            outfile.write(' powerUnit=%s' % (quote_attrib(self.powerUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FifoPowerStateType', fromsubclass_=False, pretty_print=True):
...
class FifoPowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FifoPowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FifoPowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FifoPowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.leakageCurrentValue != "0" and 'leakageCurrentValue' not in already_processed:
        ...
        if self.writeCapacitanceUnit != "pF" and 'writeCapacitanceUnit' not in already_processed:
            already_processed.add('writeCapacitanceUnit')
            outfile.write(' writeCapacitanceUnit=%s' % (quote_attrib(self.writeCapacitanceUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FifoPowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class FifoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FifoType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FifoType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FifoType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FifoType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class FifoRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FifoRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FifoRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FifoRefType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FifoRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class FifoAccessType(FifoRefType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FifoAccessType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FifoAccessType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FifoAccessType'):
        super(FifoAccessType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='FifoAccessType')
        if self.access is not None and 'access' not in already_processed:
            already_processed.add('access')
            outfile.write(' access=%s' % (quote_attrib(self.access), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FifoAccessType', fromsubclass_=False, pretty_print=True):
...
class PhysicalLinkPowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkPowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PhysicalLinkPowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PhysicalLinkPowerStateType'):
        ...
        if self.powerUnit != "pW" and 'powerUnit' not in already_processed:
            already_processed.add('powerUnit')
            outfile.write(' powerUnit=%s' % (quote_attrib(self.powerUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkPowerStateType', fromsubclass_=False, pretty_print=True):
...
class PhysicalLinkPowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkPowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PhysicalLinkPowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PhysicalLinkPowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.leakageCurrentValue != "0" and 'leakageCurrentValue' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkPowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PhysicalLinkType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PhysicalLinkType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PhysicalLinkType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class PhysicalLinkRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PhysicalLinkRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PhysicalLinkRefType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PhysicalLinkRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class DMAControllerPowerStateType(VoltageFrequencyConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerPowerStateType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='DMAControllerPowerStateType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='DMAControllerPowerStateType'):
        ...
        if self.powerUnit != "pW" and 'powerUnit' not in already_processed:
            already_processed.add('powerUnit')
            outfile.write(' powerUnit=%s' % (quote_attrib(self.powerUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerPowerStateType', fromsubclass_=False, pretty_print=True):
...
class DMAControllerPowerModelType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerPowerModelType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='DMAControllerPowerModelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='DMAControllerPowerModelType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.leakageCurrentValue != "0" and 'leakageCurrentValue' not in already_processed:
        ...
        if self.transferCapacitanceUnit != "pF" and 'transferCapacitanceUnit' not in already_processed:
            already_processed.add('transferCapacitanceUnit')
            outfile.write(' transferCapacitanceUnit=%s' % (quote_attrib(self.transferCapacitanceUnit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerPowerModelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DMAControllerType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='DMAControllerType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='DMAControllerType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class DMAControllerRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='DMAControllerRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='DMAControllerRefType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='DMAControllerRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class LogicalLinkType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='LogicalLinkType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='LogicalLinkType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='LogicalLinkType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.throughputValue is not None and 'throughputValue' not in already_processed:
        ...
        if self.frequencyDomain is not None and 'frequencyDomain' not in already_processed:
            already_processed.add('frequencyDomain')
            outfile.write(' frequencyDomain=%s' % (quote_attrib(self.frequencyDomain), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='LogicalLinkType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class LogicalLinkRefType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='LogicalLinkRefType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='LogicalLinkRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='LogicalLinkRefType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='LogicalLinkRefType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class CommunicationBufferType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommunicationBufferType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommunicationBufferType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommunicationBufferType'):
        pass
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommunicationBufferType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CommunicationPhaseType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommunicationPhaseType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommunicationPhaseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommunicationPhaseType'):
        pass
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommunicationPhaseType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CommunicationProducerType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommunicationProducerType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommunicationProducerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommunicationProducerType'):
        if self.processor is not None and 'processor' not in already_processed:
            already_processed.add('processor')
            outfile.write(' processor=%s' % (quote_attrib(self.processor), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommunicationProducerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CommunicationConsumerType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommunicationConsumerType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommunicationConsumerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommunicationConsumerType'):
        if self.processor is not None and 'processor' not in already_processed:
            already_processed.add('processor')
            outfile.write(' processor=%s' % (quote_attrib(self.processor), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommunicationConsumerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CommunicationType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='CommunicationType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='CommunicationType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='CommunicationType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='CommunicationType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PeripheralEmulatorLibraryType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PeripheralEmulatorLibraryType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PeripheralEmulatorLibraryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PeripheralEmulatorLibraryType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PeripheralEmulatorLibraryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class PeripheralType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PeripheralType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PeripheralType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PeripheralType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PeripheralType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SubsystemPlatformType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SubsystemPlatformType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SubsystemPlatformType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SubsystemPlatformType'):
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SubsystemPlatformType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SubsystemType(SubsystemPlatformType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='SubsystemType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='SubsystemType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='SubsystemType'):
        super(SubsystemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='SubsystemType')
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='SubsystemType', fromsubclass_=False, pretty_print=True):
...
class PlatformType(SubsystemPlatformType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='PlatformType', namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='PlatformType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='PlatformType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='PlatformType', fromsubclass_=False, pretty_print=True):
...
class FrequencyInputType(VoltageFrequencyDomainConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyInputType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyInputType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyInputType'):
    ...
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyInputType', fromsubclass_=False, pretty_print=True):
...
class FrequencyType(VoltageFrequencyDomainConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='FrequencyType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='FrequencyType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='FrequencyType'):
        ...
        if self.unit is not None and 'unit' not in already_processed:
            already_processed.add('unit')
            outfile.write(' unit=%s' % (quote_attrib(self.unit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='FrequencyType', fromsubclass_=False, pretty_print=True):
...
class VoltageInputType(VoltageFrequencyDomainConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageInputType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageInputType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageInputType'):
        super(VoltageInputType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='VoltageInputType')
        if self.voltageDomain is not None and 'voltageDomain' not in already_processed:
            already_processed.add('voltageDomain')
            outfile.write(' voltageDomain=%s' % (quote_attrib(self.voltageDomain), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageInputType', fromsubclass_=False, pretty_print=True):
...
class VoltageType(VoltageFrequencyDomainConditionListType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='slxmapping:', name_='VoltageType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='slxmapping:', name_='VoltageType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='slxmapping:', name_='VoltageType'):
        ...
        if self.unit is not None and 'unit' not in already_processed:
            already_processed.add('unit')
            outfile.write(' unit=%s' % (quote_attrib(self.unit), ))
    def exportChildren(self, outfile, level, namespace_='slxmapping:', name_='VoltageType', fromsubclass_=False, pretty_print=True):
...
GDSClassesMapping = {
    ...
    'Channel': ChannelType,
    'CommPrimitive': CommPrimitiveType,
...
def parse(inFileName, silence=False):
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:slxmapping="http://xsd.silexica.com/slxMapping"',
            pretty_print=True)
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from mapping import *\n\n')
        sys.stdout.write('import mapping as model_\n\n')
