...
#
# Generated Fri Oct 13 11:57:51 2017 by generateDS.py version 2.26a.
#
...
class ChannelType(GeneratedsSuper):
    ...
    def validate_ChannelBoundType(self, value):
        # Validate type ChannelBoundType, a restriction on slxplatform:NonNegativeIntType.
        if value is not None and Validate_simpletypes_:
            pass
...
class SchedulerType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, ProcessRef=None, ProcessorRef=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
